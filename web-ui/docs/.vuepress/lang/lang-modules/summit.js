...
module.exports = {
    cn: {
        SUMMIT_BANNER: {
            MOBILE_IMG: "https://openeuler-website-beijing.obs.cn-north-4.myhuaweicloud.com/openEuler-summit-2021/images/%E6%AC%A7%E6%8B%89-375x300-%E6%93%8D%E4%BD%9C%E7%B3%BB%E7%BB%9F%E9%A6%96%E9%A1%B5.png",
            PC_IMG: "https://openeuler-website-beijing.obs.cn-north-4.myhuaweicloud.com/openEuler-summit-2021/images/1920x380%E6%93%8D%E4%BD%9C%E7%B3%BB%E7%BB%9F.png"
        },
        ...
        AGENDA: {
            ...
            FORENOON_AGENDA_9: [
                ...
                },
                {
                    TIME: '10:25 - 10:55',
                    THEME: '行业用户实践分享',
                    SPEAKER: '运营商、金融等行业重磅嘉宾'
                },
                {
                    TIME: '10:55 - 11:05',
                    THEME: '携手欧拉开源创新，服务中国数字时代',
                    SPEAKER: '麒麟软件',
                },
                {
                    TIME: '11:05 - 11:15',
                    THEME: '扎根开源生态，服务中国企业，帮助中国开源系统走向世界',
                    SPEAKER: 'SUSE',
                },
                {
                    TIME: '11:15 - 11:20',
            ...
            FORENOON_AGENDA_10: [
                ...
                },
                {
                    ...
                    SPEAKER: '中国电信、中国移动、中国联通、中科创达、华为、品高软件'
                },
                {
                    TIME: '10:40 - 10:55',
                    THEME: '中国银行操作系统创新实践',
                    SPEAKER: '中国银行和麒麟软件联合演讲',
                },
                {
                    TIME: '10:55 - 11:10',
                    THEME: '中国移动云原生生态创新实践',
            ...
            AFTERNOON_AGENDA_9: [
                ...
                [
                    ...
                    {
                        TIME: '15:55 - 16:25',
                        THEME: '助力国产硬件，构建自主可控业务生态',
                        SPEAKER: '于明',
                        POSITION: '长城信息股份有限公司副总裁，人工智能所所长'
                    },
                    {
                        TIME: '16:25 - 16:55',
                        THEME: '云原生安全架构的应用实践',
                        SPEAKER: '刘玮',
                        POSITION: '上海缔赛信息技术有限公司总经理'
                    },
                    {
                        TIME: '16:55 - 17:10',
                        THEME: '观众互动',
                ...
                [
                    ...
                    {
                        TIME: '15:20 - 15:50',
                        THEME: '圆桌论坛：多样性算力、业务模式创新模式影响下，操作系统产业未来发展',
                    },
                    {
                        TIME: '15:50 - 16:10',
                        THEME: '深耕基础软件根技术，普华的铸魂之路',
                        SPEAKER: '王伶卓',
                        POSITION: '普华基础软件事业部技术副总'
                    },
                    {
                        TIME: '16:10 - 16:30',
                ...
                CARD_LIST: [
                    {
                        ...
                        ITEM_LIST: [
                            ...
                            {
                                TIME: '14:00-14:30',
                                THEME: '内存分级扩展在天翼云上的实践',
                                SPEAKER: ['张俊平 天翼云科技公司'],
                                DESC: ['使用傲腾内存，虚拟机内存超配，提升内存性价比，提升虚拟机性能']
                            },
                            {
                                TIME: '14:30-15:00',
                            ...
                            {
                                TIME: '16:00-16:30',
                                THEME: '虚拟化技术在SW64自主架构的探索与实践',
                                SPEAKER: ['张毅 中电科申泰信息科技有限公司'],
                            ...
                            {
                                TIME: '16:30-17:00',
                                THEME: '内核和进程热补丁技术的实现与应用',
                                SPEAKER: ['唐彬  中国移动云能力中心'],
                                DESC: ['在日常生产过程中，经常会遇到bug或者cve等问题需要升级内核，而当前升级内核需要重启系统，这会影响业务的连续性，为了最大限度避免重启服务器，采用热补丁的方式来修复内核bug或者cve漏洞，本主题主要介绍x86与arm64架构下的内核热补丁技术实现与应用']
                            },
                            {
                                TIME: '17:00-17:30',
                                THEME: '支持多任务的共享虚拟内存池技术',
                                SPEAKER: ['丁天虹 华为技术有限公司'],
                                DESC: ['Linux的多任务间的共享内存对SPA（Share Physiacl Address）支持比较完善，但是在支持SVA（Share Virtual Address）上使用并不方便，任务间如果要获取统一的虚拟地址，需要独立实现地址分配和管理的框架，我们在内核实现了一致性内存管理技术（Share Pool），主要解决CPU多任务之间共享虚拟地址的问题，可以较为方便的为多应用提供统一虚拟地址，该技术适合Linux在AI计算等应用场景的使用']
                            },
                        ]
                    },
                    {
                        ...
                        ITEM_LIST: [
                            ...
                            {
                                TIME: '16:00-16:30',
                                THEME: '基于云原生技术分布式构建 Linux 发行版的实践分享',
                                SPEAKER: ['王建民 中国科学院软件研究所'],
                                DESC: ['EulixOS 是最早一批基于 openEuler 操作系统研发的发行版之一。在发行版的研发过程中，时常面对编译构建周期长、依赖关系复杂、软件包迭代频繁的问题，进而时常导致研发中版本不稳定、软件包合入相互等待的问题，尤其是在编译资源有限的情况下。EulixOS在研发过程中，结合团队、资源都有限的情况下，结合云原生技术对编译构建的改造，实现了较为轻量级、易部署、多架构、分布式的编译构建系统，对于更多团队基于openEuler 操作系统进行二次的商业发行版定制有借鉴意义。']
                            },
                            {
                                TIME: '16:30-17:00',
                                THEME: '从云计算谈系统架构演化趋势',
                                SPEAKER: ['汪照辉  中国银河证券'],
                                DESC: ['对于企业IT系统构建，开源的基础操作是基本的底座，但企业IT系统融合建设的趋势已经非常明显，传统单体建设的思路已经不合时宜，所以对很多企业来说要逐步实现基础设施资源、基础平台、业务应用系统的融合，以适应业务和技术发展的需要。从虚拟化、资源池到超融合、多云管理等，其实目的都是为了实现基础设施资源的融合，能够为上层业务系统提供用之不竭的资源能力。其实从这张图我们可能很清晰的看到多云管理（混合云管理）的重要价值。对于大部分企业来说，多云管理平台不但要管理私有云、公有云，还可能需要管理企业自身的很多物理服务器，以及虚拟化平台所提供的虚拟机管理，这样才能更好的支持上层的容器的调度和管理，以满足不同业务应用容器化对不同基础设施资源的需求。所以企业系统建设中，就不能只考虑单一系统建设，必须要考虑系统与系统之间的关系，就像我们所说的，容器云平台和云管平台就是很紧密的支撑关系，而云管则可能管理着企业的物理服务器、虚拟化、超融合、网络资源、存储资源、私有云、行业云、公有云等基础设施资源，容器云平台又支撑着企业的业务应用，运行着微服务架构的中台服务、中间件、甚至轻量数据库等。所以这是一个整体的体系建设，这也是我们一直提倡“平台融合”的建设思路。当然这并不容易，一个“中台”就让无数企业铩羽而归、爱恨交加，但整个IT系统的建设趋势是逐步走向融合的，系统与系统之间需要标准化的API，就像我们一直说的积木，彼此间的切口要规则、能契合，才能比较快的搭成期待的作品。']
                            },
                            {
                                TIME: '17:00-17:30',
                                THEME: '基于可进化架构的新一代云基础设施',
                                SPEAKER: ['高广生 易捷行云'],
                                DESC: ['面对客户业务快速变化，云平台本身应具备可进化能力，EasyStack的易捷行云新一代云基础设施ECF（EasyStack Cloud Foundation）以开源生态产品化为基础，进行自主创新设计和研发构建的基于数字原生架构的一体化、场景化、可进化的全新一代云平台。已有超过500个客户在使用该产品，云基础设施ECF一套软件栈可以同时支持x86，Arm多种指令集，同时提供包括容器，云主机，裸金属多种算力，支持一个Region同时支持多种CPU架构服务器即一云多芯，同时具备全栈全平⾯OTA（Over The Air）能力，可以平滑⽆感升级包含操作系统在内的所有云平台软件，将不再受限于软件版本的限制，从⽽在某种意义上实现云平台永续⽣命周期。']
                            },
                            {
                                TIME: '17:30-18:00',
                                THEME: '虚拟化硬件加速-vDPA框架以及新浪私有云实践',
                                SPEAKER: ['杨云鹏 新浪'],
                                DESC: ['']
                            },
                        ]
                    },
                    {
                        ...
                        ITEM_LIST: [
                            ...
                            {
                                TIME: '13:30-14:00',
                                THEME: '携手openeuler应对操作系统国产化转型',
                                SPEAKER: ['叶青龙 统信软件'],
                                DESC: ['探讨操作系统国产化转型中的兼容性挑战，并分享统信软件结合迁移工具协助客户解决业务软硬件兼容问题转型欧拉版操作系统。']
                            },
                            {
                                TIME: '14:00-14:30',
                            ...
                            {
                                TIME: '14:30-15:00',
                                THEME: '欧拉开源社区全球化能力建设与展望',
                                SPEAKER: ['刘鹏 华为'],
                                DESC: ['如何服务好世界各地的开发者，匹配当地的语言、文化、开发习惯和偏好，是openEuler社区深化开源的一大挑战。openEuler G11N SIG，初步探索出了一套全球化理论和方法，并进行了若干全球化实践，希望帮助加快openEuler的全球化的进程。']
                            },
                            {
                                TIME: '15:00-15:30',
                                THEME: '茶歇',
                    ...
                    },
                    {
                        ...
                        ITEM_LIST: [
                            {
                                TIME: '13:00-13:30',
                                THEME: '为数据安全而生，统信软件备份还原工具分享',
                                SPEAKER: ['高冲 统信软件'],
                                DESC: ['统信软件将探讨系统运维中备份与恢复的常用技术方案, 并介绍统信备份还原工具的原理、解决案例以及未来的技术规划。']
                            },
                            {
                                TIME: '13:30-14:00',
                                THEME: '服务器集中运维管理系统',
                                SPEAKER: ['唐杰 湖南麒麟信安股份有限公司'],
                                DESC: ['支持大批量资产的集中管理，性能监控和告警，日志的集中存储和查询，批量软件升级，批量账户管理，u盘设备管控和安全加固。操作简便，功能强大，提高运维效率。']
                            },
                            {
                                TIME: '14:00-14:30',
                        ...
                        ITEM_LIST: [
                            {
                                ...
                                THEME: '仿真软件弹性计算',
                                SPEAKER: ['王松松 哈尔滨工业大学'],
                                DESC: ['大型仿真软件运行时多需要长时间并发运行，遇到某个计算节点挂掉后容易前功尽弃，因此发展弹性计算十分重要']
                            },
                            {
                                TIME: '13:30-14:00',
                                THEME: 'Arm64上开源分布式存储系统的生态进展',
                                SPEAKER: ['赵帅、刘新良 Linaro'],
                                DESC: ['在Arm64企业市场中，由于其多核并行计算和高性能IO的优势，使得Arm64在分布式存储领域拥有了使用场景。然而软件生态方面，Arm64依然有很长的路要走，不仅仅在于软件使能，项目CI，同时还需要针对相关场景的性能优化。Linaro和会员共同努力，致力于推动分布式存储系统的软件开发和生态进步。目前，我们已经在分布式存储系统，加速库，HPC文件系统等领域取得了一些进展。我们的工作主要基于对项目的使能，CI支持以及针对成熟系统在Arm64上的性能优化，同时也涉及了一些在openEuler上针对HPC文件系统的使能和验证。在本次分享中，我们将详细介绍盖Ceph，Rook, Lustre等项目的Arm CI进展，HPC文件系统的Arm支持以及在OpenEuler中使能和验证，以及利用PMDK等加速库对分布式存储系统进行优化的工作。']
                            },
                            {
                                TIME: '14:00-14:30',
                                THEME: '华为元戎-分布式多样性算力的理念和探索',
                                SPEAKER: ['梁义 华为'],
                                DESC: ['']
                            },
                            {
                                TIME: '14:30-15:00',
                                THEME: '欧拉开源社区GCC优化特性介绍及前瞻',
                                SPEAKER: ['马明泽 华为'],
                                DESC: ['']
                            },
                            {
